am4core.ready(function() {
  ...
  var chart = am4core.create('chart_2018', am4charts.XYChart)
  ...
  function createSeries(value, name) {
    ...
    series.columns.template.width = am4core.percent(92);
  ...
  chart.dataSource.url = "../stops/templates/stops/try2.json";
